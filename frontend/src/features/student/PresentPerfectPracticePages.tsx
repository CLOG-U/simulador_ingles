...
export function PresentPerfectPracticeStartRedirect() {
  ...
  const { mutate, isPending, error } = useMutation({
    mutationFn: fresh ? presentPerfectApi.restartPractice : presentPerfectApi.startPractice,
    onSuccess: (session) => {
    ...
    <AppShell title="Practice Result">
      <div className="space-y-4">
        ...
        <div className="flex flex-wrap gap-3">
          ...
          <Link to="/student/practice/present_perfect/start?fresh=1" className="btn-primary">
            Practice Again
          </Link>
          <Link to="/student/practice" className="inline-flex rounded-xl border px-4 py-2.5">
            Back to Practice
