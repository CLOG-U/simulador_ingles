...
from app.schemas.auth import ChangePasswordRequest, LoginRequest, LoginResponse, UserMeResponse
...
async def logout(
    ...
    await auth_service.logout(db, refresh_token=request.cookies.get("refresh_token"))
